        ...
        options: {
          twigOptions: {
            namespaces: {
              ...
              ds_elements: path.resolve(__dirname, '../', 'biu_ds/src/01-elements'),
              ds_patterns: path.resolve(__dirname, '../', 'biu_ds/src/02-patterns'),
              ds_components: path.resolve(__dirname, '../', 'biu_ds/src/03-components'),
              ds_templates: path.resolve(__dirname, '../', 'biu_ds/src/04-templates'),
            },
          },
        },
      },
